...
const MenLattest = () => {
	...
	return (
		<div className='lattest-container' id='mens'>
						...
						<Slider {...settings}>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/man-model-3.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/footwear-1.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/man-model-4.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/men-model-6.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/man-model-5.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
