...
const WomenLattest = () => {
	...
	return (
		<div className='lattest-container' id='womens'>
			<div className='lattest-div'>
				<div className='lattest-texts'>
					<h3 className='lattest-title'>Women's Lattest Fits'</h3>
						...
						<Slider {...settings}>
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-1.jpg'
											alt=''
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-2.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-3.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-4.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-5.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
							...
							<div className='slider-img-div'>
								<div className='slider-img-top'>
									<div className='slider-img-top-inner'>
										<img
											src='./assets/uploads/woman-model-6.jpg'
											alt=''
											className='slider-image'
										/>
									</div>
